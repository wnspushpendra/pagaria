...
void mainCallback(String id, DownloadTaskStatus status, int progress) {
  int statusValue = status.index; // Convert DownloadTaskStatus enum to integer
  print('Download task ($id) is in status ($statusValue) and process ($progress)');
}
