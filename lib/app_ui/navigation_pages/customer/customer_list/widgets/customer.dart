...
class _CustomerScreenState extends State<CustomerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: appBarWidget(context, 'Customer', ()=> onPopReplace(context, homeRoute)),
      ...
      body: Container(
        ...
        child: GridView.builder(
            ...
            itemBuilder: (context,index){
              return  CustomerListItem(name: 'Yuvraj Singh', contactNumber: '0123456789', emailAddress: 'yuvi@gmail.com', add: '54 vijay nagar indore', onPressed: (){},);
            })
