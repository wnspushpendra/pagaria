                  ...
                  CustomButton(
                      ...
                      onClick: () async {
                        ...
                        if (user.roleId == '4') {
                          ...
                          locationData = await checkLocationPermission();
                          placeMark = await getAddressFromLatLng(locationData!);
                          locationData != null ? submitOrderRequest('4')
                              : checkLocation();
                        } else {
...
/*        context.read<OrderBloc>().add(OrderSubmitEvent(
                              ...
                              locationData: locationData!,
                              placeMark: placeMark,
                              pinCode: showAddressDetailsField ? pinCodeController.text : widget.user.zipCode!,
                              houseNo: showAddressDetailsField ? houseNoController.text : widget.user.houseNumber!,
                              town: showAddressDetailsField ? townController.text : widget.user.town!,
                              address: showAddressDetailsField ? addressController.text : widget.user.address!,
                              city: showAddressDetailsField ? cityController.text : widget.user.city!,
                              state: showAddressDetailsField ? stateController.text : widget.user.state!,
                              landMark: showAddressDetailsField ? landmarkController.text : widget.user.landmark!));
                       */
